...
import { FormGroup, InputGroup, Label, Input, InputGroupAddon, InputProps } from "reactstrap";
...
export type FormFieldProps = {
    ...
    inputOptions?: Omit<InputProps, 'onChange' | 'type' | 'value' | 'id' | 'required' | 'readOnly' | 'disabled'>;
}

export const FormField: FC<FormFieldProps> = ({id,label,value,type,onChange, inputOptions, icon, required, readOnly, disabled}) => {
    ...
    return (
        <FormGroup className="mb-4">
            ...
            <InputGroup className="reverse-icon">
                ...
                {type === 'password' ? (
                            <div className={`input-group-eye ${inputType === 'password' ? 'password-lock' : null}`} onClick={toggleInputPasswordType}>
