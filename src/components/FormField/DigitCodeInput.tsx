import React, { FC, useState, useEffect, useRef, PropsWithChildren, ReactNode } from "react";
...
export const DigitCodeInput: FC<DigitCodeInputProps> = ({ loading, onChange, children, values, errorMessage}) => {
...
export type UncontrolledDigitCodeInputProps = Omit<DigitCodeInputProps, 'onChange' | 'values'> & {
    onComplete: (value: string) => void;
    length: number;
  }
  export const UncontrolledDigitCodeInput: FC<UncontrolledDigitCodeInputProps> = (props) => {
