    ...
    return (
        <FormGroup>
            ...
            <InputGroup className="mb-4" id="password-eye">
                <Input type={inputType} id={id} placeholder={placeholder} required value={value} onChange={onChange} />
            ...
            <Input type="password" id={`${id}-reenter`} placeholder={confirmPlaceholder} value={confirmValue} onChange={onChangeConfirm} />
        </FormGroup>
    )
}