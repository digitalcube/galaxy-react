      ...
      <DomainListRow>
        <DomainListItem domainName="example.com">
          ...
          <DomainDropdownMenu right>
            <DomainDropdownMenuItem className="make-primary">
              Make Primary
            </DomainDropdownMenuItem>
            <DomainDropdownMenuItem
              className="view-dns-record"
              data-toggle="modal"
              data-target="#dns-record-modal"
            >
              View DNS Records
            </DomainDropdownMenuItem>
            <DomainDropdownMenuItem
        ...
        <DomainListItem domainName="example.com">
          ...
          <div className="ml-3 domain-action">
            ...
            >
              <a
                className="dropdown-item make-primary px-3 py-2 d-flex align-items-center justify-content-between"
                href="#"
              >
                Make Primary
              </a>
              <a
                className="dropdown-item view-dns-record px-3 py-2 d-flex align-items-center justify-content-between"
                href="#"
                data-toggle="modal"
                data-target="#dns-record-modal"
              >
              ...
              <a
                className="dropdown-item delete px-3 py-2 d-flex align-items-center justify-content-between"
                href="#"
                data-toggle="modal"
                data-target="#delete-modal"
              >
        ...
        <div className="domain-list-item mt-2 px-3 py-3 rounded d-flex align-items-center justify-content-between">
          ...
          <div className="domain-misc d-flex align-items-center">
            <div className="domain-status">
              <div className="rounded font-weight-bold c-site-status c-is-pending">
