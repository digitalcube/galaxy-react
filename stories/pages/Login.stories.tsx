...
import {
    ...
    AuthFormHeader, FormField, FeaturePromotionBlock, Layouts, Button,
                    ...
                    <LoginFormLayout status={status}>
                            <form noValidate onSubmit={(e) => {
                                ...
                                <FormField
                                    ...
                                    type="text"
                                    value={username}
                                    errorMessage={currentStatus === 'failure' ? 'We don’t recognize that email': undefined}
                                />
                                <FormField
                                    id="password"
                                    label="Password"
                                    ...
                                    type="password"
                                    value={password}
                                    errorMessage={currentStatus === 'failure' ? 'We don’t recognize that password': undefined}
                                />
                                <Checkbox
                                    label="Remember me"
                                    id="remember"
                                    ...
                                    onChange={() => undefined}
                                />
                                <Button type="submit" block disabled={!canSubmit}>Log In</Button>
...
const Template: Story<MockLoginPageProps> = args => <MockLoginPage {...args} />;
